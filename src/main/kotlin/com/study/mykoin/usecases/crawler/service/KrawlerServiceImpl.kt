...
import com.study.mykoin.usecases.crawler.model.FiiExtractedInformation
import com.study.mykoin.usecases.kafka.KafkaFactory
import com.study.mykoin.usecases.kafka.TopicEnum
import com.study.mykoin.usecases.kafka.sendMessage
...
class KrawlerServiceImpl : KrawlerService {
    ...
    override fun handle(url: String, data: KrawlDocument?) {
        ...
        kafkaFactory.getProducer().sendMessage(
            TopicEnum.FIIS_TOPIC.topicName,
            fiiName,
