package com.study.mykoin.usecases.crawler

import com.study.mykoin.usecases.crawler.service.KrawlerService
...
class Krawler {
    ...
    @Autowired
    private lateinit var walletStorage: FiiStorage
    ...
    fun init() {
        try {
            ...
            walletStorage.findAll()?.also { walletSet.addAll(it) }
                .also {
                    logger.info("Searching for: ${it?.map { it.name }}")
                }
